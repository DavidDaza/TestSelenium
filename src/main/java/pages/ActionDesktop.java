...
//    ActionChains actions = ActionChains(driver);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ad.iniciarApp("C:\\putty.exe", System.getProperty("user.dir") + "\\Winium.Desktop.Driver.exe");
    ...
    public void iniciarApp(String path, String instancia) {
        try {
            ...
            //
            System.out.println("Error DESKTOP(2000): No Fue Posible Iniciar La Aplicacion " + e.getMessage() +" "+e.toString());
        }
    }
